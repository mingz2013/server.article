...
class RedisClient():
    ...
    @staticmethod
    def set_event_key(id):
        redis_client.hset(EVENT_KEY, id, True)

    @staticmethod
    def get_event_key(id):
        return redis_client.hget(EVENT_KEY, id)

    @staticmethod
    def del_event_key(id):
        redis_client.hdel(EVENT_KEY, id)
